...
Route::middleware([SessionMiddleware::class])->group(function() {
    ...
    Route::middleware(['role:student'])->group(function() {
        ...
        Route::delete('/student/notifications/{id}', [LessonController::class, 'deleteNotification'])->name('student.notifications.delete');
        ...
        // Assignment Actions
        Route::get('/assignments/view', [AssignmentController::class, 'viewStudentAssignment'])->name('assignments.viewStudentAssignment');
